<template>
  <div
    ...
    @click="wrapClick"
  >
    <div ref="elem" class="vue-slide-bar" :style="{
      ...
      <template>
        ...
        >
          <span v-if="showTooltip" :style="tooltipStyles" class="vue-slide-bar-tooltip"></span>
        </div>
      </template>
    ...
    <div v-if="range" class="vue-slide-bar-range">
      ...
      >
        <span v-if="!r.isHide" class="vue-slide-bar-separate-text">{{ r.label }}</span>
      </div>
    </div>
  </div>
</template>
